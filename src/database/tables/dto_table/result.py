...
class ResultTable(Table[Result]):
    ...
    def get_where_name_ge(self, value: str) -> list[Result]:
        return self.get_all_from_attributes_with_comparator(
            (("Name", Comparator.GE, value),)
        )

    def get_where_name_le(self, value: str) -> list[Result]:
        return self.get_all_from_attributes_with_comparator(
            (("Name", Comparator.LE, value),)
        )

    def get_where_name_in_range(
        self, lower_inclusive: str, upper_inclusive: str
    ) -> list[Result]:
        return self.get_all_from_attributes_with_comparator(
            (
                ("Name", Comparator.GE, lower_inclusive),
                ("Name", Comparator.LE, upper_inclusive),
            )
        )
    ...
    def get_where_date_ge(self, value: str) -> list[Result]:
        return self.get_all_from_attributes_with_comparator(
            (("Date", Comparator.GE, value),)
        )

    def get_where_date_le(self, value: str) -> list[Result]:
        return self.get_all_from_attributes_with_comparator(
            (("Date", Comparator.LE, value),)
        )

    def get_where_date_in_range(
        self, lower_inclusive: str, upper_inclusive: str
    ) -> list[Result]:
        return self.get_all_from_attributes_with_comparator(
            (
                ("Date", Comparator.GE, lower_inclusive),
                ("Date", Comparator.LE, upper_inclusive),
            )
        )
